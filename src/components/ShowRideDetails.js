                    ...
                    <div className="col-md-4 text-black">
                        {!Dchat ? (
                            <>
                                <div
                                    style={{
                                        boxShadow: "0px 6px 6px 6px rgba(0.2, 0.2, 0.2, 0.2)", // Adding box shadow
                                        borderRadius: "10px", // Adding border radius for rounded corners
                                        padding: "20px", // Adding padding for spacing
                                        marginBottom: "20px", // Adding margin bottom for spacing
                                    }}
                                >
                                    <h3 style={{ fontSize: "1.5rem" }}> Applicants :</h3>
                                    <br />
                                    {rideDetails ? (
                                        <>
                                                ...
                                                <div key={index} style={{ marginBottom: "10px" }}>
                                                    <div
                                                        style={{
                                                            ...
                                                            backgroundColor: "#7BC9FF", // Adding background color
                                                            boxShadow: "0px 0px 5px rgba(0, 0, 0, 0.1)", // Adding box shadow
                                                        ...
                                                        {showOtpInput ? (
                                                            <div>
                                                                <input
                                                                    ...
                                                                    style={{
                                                                        padding: "10px", // Adding padding for spacing
                                                                        marginRight: "10px", // Adding margin for spacing between input and button
                                                                        borderRadius: "5px", // Adding border radius for rounded corners
                                                                        border: "1px solid #ccc", // Adding border for visual separation
                                                                    }}
                                                                />
                                                                <button
                                                                    className="btn btn-primary"
                                                                    ...
                                                                    style={{
                                                                        ...
                                                                        borderRadius: "5px", // Adding border radius for rounded corners
                                                                        backgroundColor: "#007bff", // Setting background color
                                    ...
                                    {!showConfirmationModal && <button
                                        className={`btn ${rideCompleted ? "btn-success" : "btn-primary"
                                            } my-0`}
                                        style={{ marginTop: '0px' }}
                                    ...
                                    {showConfirmationModal && (
                                        <div className="">
                                            <div className="content">
                                                <span className="close" style={{ fontSize: '2rem', cursor: 'pointer' }} onClick={handleCancelComplete}>
                                                    &times;
                                                </span>
